            ...
            .then(() => {
              flightSuretyApp.methods
                ...
                .then((result) => {
                  oracles.push(result);
                  console.log(
                    `Oracle Registered: ${result[0]}, ${result[1]}, ${result[2]} at ${account}`
                  );
                  rounds -= 1;
                  if (!rounds) {
                    resolve(oracles);
              ...
              for (let idx = 0; idx < 3; idx += 1) {
                ...
                if (selectedCode.code === 20) {
                  ...
                  flightSuretyData.methods
                    ...
                    .then((result) => {
                      console.log(result);
                      console.log(
                        `Flight ${flight} got covered and insured the users`
                      );
                    })
                    .catch((err) => {
                      console.log(err.message);
                ...
                flightSuretyApp.methods
                  ...
                  .then((result) => {
                    found = true;
                    console.log(
                      `Oracle: ${oracle[idx]} responded from flight ${flight} with status ${selectedCode.code} - ${selectedCode.label}`
                    );
                  })
                  .catch((err) => {
                    console.log(err.message);
